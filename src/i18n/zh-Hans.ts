...
const zhHans: Partial<Translations> = {
  ...
  'model.escCancel': '取消',
  'model.enterSave': '保存',
  'model.contextWindow': '上下文长度 (tokens)',
  'model.maxInput': '最大输入 (tokens)',
  'model.maxOutput': '最大输出 (tokens)',
  'model.maxContextTokensFull': '上下文总长度(输入 + 输出)的 token 数',
  'model.maxInputTokensFull': '单次请求最大输入 token 数',
  'model.maxOutputTokensFull': '单次响应最大输出 token 数',
  'model.tokens': '上下文',
  'server.compute': '算力',
  'server.stdout': '标准输出',
