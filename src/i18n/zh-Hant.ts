...
const zhHant: Partial<Translations> = {
  ...
  'model.escCancel': '取消',
  'model.enterSave': '儲存',
  'model.contextWindow': '上下文長度 (tokens)',
  'model.maxInput': '最大輸入 (tokens)',
  'model.maxOutput': '最大輸出 (tokens)',
  'model.maxContextTokensFull': '上下文總長度(輸入 + 輸出)的 token 數',
  'model.maxInputTokensFull': '單次請求最大輸入 token 數',
  'model.maxOutputTokensFull': '單次回應最大輸出 token 數',
  'model.tokens': '上下文',
  'server.compute': '算力',
  'server.stdout': '標準輸出',
