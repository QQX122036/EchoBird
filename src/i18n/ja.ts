...
const ja: Partial<Translations> = {
  ...
  'model.enterSave': '保存',
  'model.contextWindow': 'コンテキスト長 (tokens)',
  'model.maxInput': '最大入力 (tokens)',
  'model.maxOutput': '最大出力 (tokens)',
  'model.maxContextTokensFull': 'コンテキスト全体のトークン数(入力 + 出力)',
  'model.maxInputTokensFull': 'リクエストごとの最大入力トークン数',
  'model.maxOutputTokensFull': 'レスポンスごとの最大出力トークン数',
  'model.tokens': 'トークン',
